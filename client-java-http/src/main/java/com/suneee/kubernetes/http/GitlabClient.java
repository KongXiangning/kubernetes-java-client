...
public class GitlabClient implements ApiClient{

    private static OkHttpClient httpClient;
    private static GitlabClient apiClient = new GitlabClient();
    ...
    private GitlabClient(){
        ...
        authentications.put("BasicAuth" , new PrivateToken());
    ...
    public static GitlabClient getApiClient(){
        return apiClient;
    }
