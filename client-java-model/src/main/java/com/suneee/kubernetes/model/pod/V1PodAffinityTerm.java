...
public class V1PodAffinityTerm {
  ...
  **/
  ...
  public V1PodAffinityTerm addNamespacesItem(String namespacesItem) {
   ...
   /**
   * namespace specifies which namespace the labelSelector applies to (matches against); null or empty list means \&quot;this pod&#39;s namespace\&quot;
   * @return namespace
  **/
  @ApiModelProperty(value = "namespace specifies which namespace the labelSelector applies to (matches against); null or empty list means \"this pod's namespace\"")
  ...
  public V1PodAffinityTerm topologyKey(String topologyKey) {
   ...
   /**
   * This pod should be co-located (affinity) or not co-located (anti-affinity) with the pods matching the labelSelector in the specified namespace, where co-located is defined as running on a node whose value of the label with key topologyKey matches that of any node on which any of the selected pods is running. Empty topologyKey is not allowed.
   * @return topologyKey
  **/
  ...
  public String toString() {
    ...
    sb.append("    namespace: ").append(toIndentedString(namespaces)).append("\n");
