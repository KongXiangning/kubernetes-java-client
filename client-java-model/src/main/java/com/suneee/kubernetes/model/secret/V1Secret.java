...
package com.suneee.kubernetes.model.secret;
...
public class V1Secret {
  ...
  **/
  ...
  public V1Secret(String namespace,String name){
    this();
    setNamespace(namespace);
    setName(name);
  }

  public V1Secret setNamespace(String namespace){
  ...
  public V1Secret setName(String name){
