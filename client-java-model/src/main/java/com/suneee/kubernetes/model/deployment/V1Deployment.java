...
public class V1Deployment {
  ...
  public V1Deployment(){
    ...
    this.spec = new V1DeploymentSpec();
  }

  public V1Deployment(V1ObjectMeta metadata,V1DeploymentSpec spec){
    this.apiVersion = "extensions/v1beta1";
    this.kind = "Deployment";
  ...
  public V1Deployment(String namespace,String name){
    this();
  ...
  public V1Deployment addEnv(String key,String value){
    return addEnv(0,key,value);
  }

  public V1Deployment addEnv(int index,String key,String value){
  ...
  public V1Deployment addPort(Integer port){
    return addPort(0,port);
  }

  public V1Deployment addPort(int index,Integer port){
    if (spec.getTemplate().getSpec().getContainers().get(index) != null){
  ...
  public V1Deployment setResource(String limitsCpu,String limitsmem){
    return setResource(0,limitsCpu,limitsmem);
  }

  public V1Deployment setResource(String limitsCpu,String limitsmem,String requestsCpu,String requestsmen){
    return setResource(0,limitsCpu,limitsmem,requestsCpu,requestsmen);
  }

  public V1Deployment setResource(int index,String limitsCpu,String limitsmem){
    return setResource(index,limitsCpu,limitsmem,null,null);
  }

  public V1Deployment setResource(int index,String limitsCpu,String limitsmem,String requestsCpu,String requestsmen){
    if (spec.getTemplate().getSpec().getContainers().get(index) != null){
