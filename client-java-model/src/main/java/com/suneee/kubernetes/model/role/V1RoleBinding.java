...
public class V1RoleBinding {
  ...
  public V1RoleBinding(String namespace,String name){
    this();
  ...
  public V1RoleBinding addLabel(String key,String value){
  ...
  **/
  ...
  public V1RoleBinding setRoleRef(String apiGroup,String kind,String name){
    this.roleRef = new V1RoleRef();
    this.roleRef.apiGroup(apiGroup).kind(kind).name(name);
    return this;
  }
  ...
  public V1RoleBinding addSubjectsItem(String kind,String name) {
    return addSubjectsItem(new V1Subject().kind(kind).name(name));
  }
