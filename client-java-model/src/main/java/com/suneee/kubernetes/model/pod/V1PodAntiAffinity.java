...
import com.suneee.kubernetes.model.V1WeightedPodAffinityTerm;
...
public class V1PodAntiAffinity {
  ...
  public V1PodAntiAffinity addPreferredDuringSchedulingIgnoredDuringExecutionItem(V1PodAffinityTerm podAffinityTerm,Integer weight) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) {
      this.preferredDuringSchedulingIgnoredDuringExecution = new ArrayList<V1WeightedPodAffinityTerm>();
    }
    V1WeightedPodAffinityTerm preferredDuringSchedulingIgnoredDuringExecutionItem = new V1WeightedPodAffinityTerm();
    preferredDuringSchedulingIgnoredDuringExecutionItem.setPodAffinityTerm(podAffinityTerm);
    preferredDuringSchedulingIgnoredDuringExecutionItem.setWeight(weight);
    this.preferredDuringSchedulingIgnoredDuringExecution.add(preferredDuringSchedulingIgnoredDuringExecutionItem);
    return this;
  }
