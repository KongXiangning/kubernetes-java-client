...
package com.suneee.kubernetes.model.storage;

import com.google.gson.annotations.SerializedName;
import com.suneee.kubernetes.model.V1ObjectReference;
...
public class V1StorageOSPersistentVolumeSource {
  ...
  **/
  ...
  public V1StorageOSPersistentVolumeSource volumeNamespace(String volumeNamespace) {
   ...
   /**
   * VolumeNamespace specifies the scope of the volume within StorageOS.  If no namespace is specified then the Pod&#39;s namespace will be used.  This allows the Kubernetes name scoping to be mirrored within StorageOS for tighter integration. Set VolumeName to any name to override the default behaviour. Set to \&quot;default\&quot; if you are not using namespace within StorageOS. Namespaces that do not pre-exist within StorageOS will be created.
